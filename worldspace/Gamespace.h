...
public:
	...
	[[nodiscard]] ActorBase* getActorAt(unsigned int posX, unsigned int posY);
	[[nodiscard]] ItemStaticBase* getItemAt(const Coord& pos);
	[[nodiscard]] ItemStaticBase* getItemAt(unsigned int posX, unsigned int posY);
	[[nodiscard]] Player& getPlayer();
//	[[nodiscard]] Tile* getTile(const Coord& pos);
//	[[nodiscard]] Tile* getTile(unsigned int x, unsigned int y);
